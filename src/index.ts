...
export class JiraServerConnector {
    ...
    /**
     * Contains all operations from '/rest/api/latest/statuscategory'
     */
    statusCategories: StatusCategoryEndpoint;

    /**
     * Contains all operations from '/rest/api/latest/universal_avatar'
     */
    ...
    /**
     * Contains all operations from '/rest/api/latest/version'
     */
